  ...
  return (
    <Section id="service-area" tone="bone">
      <div className="grid gap-12 lg:grid-cols-[1fr_1.2fr] lg:items-center lg:gap-16">
        <div>
          <p className="eyebrow mb-4 text-chrome-deep">{serviceArea.eyebrow}</p>
          ...
          <a href={cta.href} className="btn-dark mt-7 px-7 py-4 text-base">
            {serviceArea.cta}
          </a>
        </div>
        ...
        <ul className="grid grid-cols-2 gap-3 sm:grid-cols-3">
          {serviceArea.towns.map((town) => (
            ...
            >
              <MapPin
                className="h-4 w-4 shrink-0 text-chrome-deep"
                aria-hidden="true"
              />
              {town}
            </li>
